 ...
 * @param {unknown} [options.patchFile] explicit patch file path (string).
 * @param {unknown} [options.profile] profile name (string; defaults to 'web').
 * @param {string | undefined} [options.dshHome] explicit harness home.
 * @returns {string}
 */
...
/** @type {Promise<typeof import('js-yaml')> | undefined} */
let yamlPromise;
 ...
 * @returns {Promise<import('js-yaml').Schema>}
 */
async function entryListSchema() {
  ...
  const JsExprType = new yaml.Type('tag:yaml.org,2002:js', {
    ...
    predicate: isJsExpr,
    represent: (data) => (/** @type {{ __jsExpr: unknown }} */ (data)).__jsExpr,
  });
 ...
 * @param {string} file
 * @returns {Promise<import('./types.js').PatchRow[]>}
 */
 ...
 * @param {string} file
 * @param {import('./types.js').PatchRow[]} rows
 ...
 * @param {string} file
 * @param {(rows: import('./types.js').PatchRow[]) => import('./types.js').PatchRow[] | Promise<import('./types.js').PatchRow[]>} edit
 * @returns {Promise<import('./types.js').PatchRow[]>}
 */
 ...
 * @param {import('./types.js').PatchRow[]} rows
 * @param {string} id
 * @returns {{ kind: 'row', row: import('./types.js').PatchRow } | { kind: 'insert', row: import('./types.js').PatchRow, item: import('./types.js').PatchEntry } | undefined}
 */
 ...
 * @param {import('./types.js').PatchRow[]} rows
 * @param {string} id
 * @param {import('./types.js').McpServerConfig} config
 * @returns {import('./types.js').PatchRow[]}
 */
...
export function setMcpEnabled(rows, id, enabled) {
  ...
  return rows.map((row) =>
    row === found.row
      ? {
          ...row,
          insert: (/** @type {import('./types.js').PatchEntry[]} */ (row.insert)).map((entry) =>
